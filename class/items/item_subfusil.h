...
class Item_subfusil:public Item_base
{
	///////////////////////////
	...
	virtual void transformar_bloque(Bloque_transformacion_representable &b) const
	{
		...
		Frame_sprites f=acc_tabla_sprites().obtener(35);
		if(f)
		{
	...
	virtual std::string a_cadena() const {return "ITEM SUBFUSIL";}

	public:

	Item_subfusil():Item_base() {}
	virtual ~Item_subfusil() {}
