#ifndef ITEM_PISTOLA_H
#define ITEM_PISTOLA_H

#include "item_base.h"

class Item_pistola:public Item_base
{
	///////////////////////////
	...
	virtual void transformar_bloque(Bloque_transformacion_representable &b) const
	{
		...
		Frame_sprites f=acc_tabla_sprites().obtener(20);
		if(f)
		{
	...
	virtual std::string a_cadena() const {return "ITEM PISTOLA";}

	public:

	Item_pistola():Item_base() {}
	virtual ~Item_pistola() {}
