...
class Espaciable
{
	...
	void ajustar_izquierda_de(const Espaciable& e) {ajustar_izquierda_de(e.copia_caja());}
	void ajustar_derecha_de(const Espaciable& e) {ajustar_derecha_de(e.copia_caja());}
	void ajustar_encima_de(const Espaciable& e) {ajustar_encima_de(e.copia_caja());}
	void ajustar_debajo_de(const Espaciable& e) {ajustar_debajo_de(e.copia_caja());}

	void ajustar_izquierda_de(const Espaciable::t_caja& c) {mut_x_caja(c.origen.x-acc_espaciable_w());}
	void ajustar_derecha_de(const Espaciable::t_caja& c) {mut_x_caja(c.origen.x+c.w);}
	void ajustar_encima_de(const Espaciable::t_caja& c) {mut_y_caja(c.origen.y-acc_espaciable_h());}
	void ajustar_debajo_de(const Espaciable::t_caja& c) {mut_y_caja(c.origen.y+c.h);}
